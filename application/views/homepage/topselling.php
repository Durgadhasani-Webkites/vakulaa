    ...
    <div class="container">
        <center>
            <div class="offertext">
                ...
                <div CLASS="offersbox">
                    <?php $home_heading_2 = (!empty($web_settings['home_heading_2']))?$web_settings['home_heading_2']:'Top Selling';
                    $home_heading_2_arr = explode(' ',$home_heading_2);
                    $home_heading_2_text1 = strtoupper(array_shift(array_slice($home_heading_2_arr,0,1)));
                    $home_heading_2_text2 = strtoupper(implode(' ' ,(array_slice($home_heading_2_arr,1))));
                    ?>
                    <center class="font24 oswald"><span ><?php echo $home_heading_2_text1; ?> </span> <span><?php echo $home_heading_2_text2; ?> </span></center>
                </div>
            </div>
        </center>
