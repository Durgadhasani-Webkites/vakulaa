    ...
    <div class="tray tray-center" style="height: 510px;">
        ...
        <div class="panel mb25 mt5">
            ...
            <div class="panel-heading">
                ...
                <span class="panel-title hidden-xs"> Add Tax Settings</span>
            ...
            <div class="panel-body p20 pb10">
                ...
                <div class="tab-content pn br-n admin-form">
                    ...
                    <div class="tab-pane active" id="tab1_1">
                        ...
                        <form  id="add_frm" action="<?php echo base_url('admin/tax_settings/process_add'); ?>" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="field prepend-icon" for="">
                                        ...
                                        <input type="text" placeholder="Enter Tax Name" class="event-name gui-input br-light light" id="tax_name" name="tax_name">
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="field prepend-icon" for="">
                                        ...
                                        <input type="text" placeholder="Enter Tax Rate" class="event-name gui-input br-light light" id="tax_value" name="tax_value">
