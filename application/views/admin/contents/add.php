    ...
    <div class="tray tray-center" style="height: 510px;">
        ...
        <div class="panel mb25 mt5">
            <div class="panel-heading">
                <span class="panel-title hidden-xs"> Add Content</span>
            </div>
            <div class="panel-body p20 pb10">
                <div class="tab-content pn br-n admin-form">
                    <div class="tab-pane active" id="tab1_1">
                        <form  id="add_frm" action="<?php echo base_url('admin/contents/process_add'); ?>" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                            <div class="section row">
                                <div class="col-md-10">
                                    <h5><small>Title</small></h5>
                                    <label class="field prepend-icon" for="">
                                        <input type="text" placeholder="page title" class="event-name gui-input br-light light" id="page_title" name="page_title">
                            ...
                            <div class="section row">
                                <div class="col-md-10">
                                    ...
                                    <textarea name="page_content" class="form-control summernote" style="height: 400px;" placeholder="page content"></textarea>
                                    <em class="state-error" for="page_content"></em>
                                </div>
                            </div>
                            <div class="section row">
                                <div class="col-md-10">
                                    ...
                                    <label class="field prepend-icon" for="">
                                        <textarea name="short_content" class="form-control limitchar" id="short_content" maxlength="450" placeholder="Write your content here" style="height: 100px;" ></textarea>
                            ...
                            <div class="section row">
                                <div class="col-md-10">
                                    ...
                                    <label class="field prepend-icon" for="">
                                        <input type="text" placeholder="meta title" class="event-name gui-input br-light light" id="meta_title" name="meta_title">
                                        <label class="field-icon" for="">
                                            <i class="fa fa-edit"></i>
                                        </label>
                            ...
                            <div class="section row">
                                <div class="col-md-10">
                                    ...
                                    <label class="field prepend-icon" for="">
                                        <textarea name="meta_description" placeholder="meta description" id="meta_description" class="form-control"  rows="3"></textarea>
                                        <label class="field-icon" for="">
                                            <i class="fa fa-edit"></i>
                                        </label>
                            ...
                            <div class="section row">
                                <div class="col-md-10">
                                    ...
                                    <label class="field prepend-icon" for="">
                                        <textarea name="meta_keywords" placeholder="meta keywords" id="meta_keywords" class="form-control"  rows="3"></textarea>
                                        <label class="field-icon" for="">
                                            <i class="fa fa-edit"></i>
                                        </label>
