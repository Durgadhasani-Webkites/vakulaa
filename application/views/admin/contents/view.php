    ...
    <div class="row">
        <div class="panel">
            <div class="panel-body pn">
                ...
                <form  id="action_frm" action="<?php echo base_url('admin/contents/process_action'); ?>" method="post" class="form-horizontal" role="form">
                    <?php } ?>
                        ...
                        <?php if(!empty($admin_results)){ ?>
                            ...
                            foreach($admin_results as $admin_result_row){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $admin_result_row['page_title']; ?></td>
                                    ...
                                    <td class="">
                                        <div class="btn-group text-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li>
                                                    <a title="click to edit" href="<?php echo base_url('admin/contents/edit/'.$admin_result_row['id']);?>">Edit</a>
                                                    <a title="click to show" href="<?php echo base_url('admin/contents/approve/'.$admin_result_row['id']);?>">Show</a>
                                                    <a title="click to hide" href="<?php echo base_url('admin/contents/disapprove/'.$admin_result_row['id']);?>">Hide</a>
                                                    <a class="confirm-alert" title="click to delete" href="<?php echo base_url('admin/contents/delete/'.$admin_result_row['id']);?>">Remove</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
