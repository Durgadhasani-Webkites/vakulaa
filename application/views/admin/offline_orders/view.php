    ...
    <div class="row">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <form id="search_frm" method="get" class="form-horizontal" role="form">
                    ...
                    <div class="row ph15 mb10">
                        ...
                        <div class="col-lg-1 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <a href="<?php echo base_url(); ?>admin/offline_orders" class="btn btn-default btn-block" id="clear">Clear</a>

                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
                            <a class="btn btn-primary btn-block" href="<?php echo base_url(); ?>admin/offline_orders/get_export_form" title="Export Order" data-target="#globalModal" data-toggle="modal" >Export</a>
                        </div>
                ...
                <form  id="action_frm" action="<?php echo base_url('admin/offline_orders/process_action'); ?>" method="post" class="form-horizontal" role="form">
    ...
    $(document).ready(function() {
        ...
        datatable.dataTable({
            ...
            "ajax": {
                ...
                'url': base_url + "offline_orders/ajax_index",
