...
<section id="content" class="">
    ...
    <form  id="attibute_frm" action="<?php echo base_url('admin/attributes/process_add'); ?>" method="post" class="form-horizontal" role="form" >
        <!-- dashboard tiles -->
        <div class="row">
            <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <div class="bs-component">
                        <input type="text" name="attribute_group_name" placeholder="Enter attribute group name" class="form-control" >
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" name="attribute_group_order" placeholder="Enter sort order" class="form-control" >
                </div>
            </div>
            <div class="form-group">
