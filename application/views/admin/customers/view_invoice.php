                            ...
                            <td>
                                ...
                                <table  width="100%" border="0" cellspacing="0" cellpadding="10" style="font-size:14px; line-height:20px; font-family:Open Sans, 'Times New Roman', Times, serif;">
                                    <tr style="font-weight:bold;">
                                        ...
                                        <td  align="center" style="border-bottom:2px solid #4F7F31; border-top:1px solid #4F7F31; font-size:13px;">DESCRIPTION</td>
                                        <td width="15%" align="center" style="border-bottom:2px solid #4F7F31; border-top:1px solid #4F7F31; font-size:13px;">UNIT PRICE</td>
                                        <td width="15%" align="center" style="border-bottom:2px solid #4F7F31; border-top:1px solid #4F7F31; font-size:13px;">QUANTITY</td>
                                        <td width="15%" align="right" style="border-bottom:2px solid #4F7F31; border-top:1px solid #4F7F31; font-size:13px;">SUB TOTAL</td>
                                    </tr>
                                    <?php
                                    $total_price=0;
                                    $total_cart_items=0;
