        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <?php if(isset($cart_items) && !empty($cart_items)) { ?>
                    ...
                    echo form_open_multipart(base_url().'admin/trash_orders/change_order_status', $attributes);
                    ?>
                                                    ...
                                                    <td align="center" style="border-bottom:1px solid #cccccc;">
                                                        ...
                                                        <tr>
                                                            <td height="80" colspan="1" align="left" valign="top">
                                                                ...
                                                                <p><strong>Mobile:</strong> <?php echo $order_details['shipping_user_contact_no']; ?></p><br />
                        ...
                        <script type="text/javascript">
                            $(function(){
                                ...
                                $('.print_invoice').click(function(){
                                    $.ajax({
                                        url:'<?php echo base_url('admin/trash_orders/print_invoice/' . $order_details['id']); ?>',
                                        type:'post',
