            ...
            foreach($admin_results as $admin_details){ ?>
                <tr>
                    ...
                    <td>
                     ...
                     <td><a title="click to edit" href="<?php echo base_url('admin/partners/contact_readmore/'.$admin_details['id']);?>" class="btn btn-success btn-sm mb5">Read More</a></td>
                     <td><a title="click to edit" href="<?php echo base_url('admin/partners/contact_delete/'.$admin_details['id']);?>" class="btn btn-danger btn-sm mb5" id='action_frm'>Remove</a></td>
                </tr>
            <?php
            }
        } ?>
