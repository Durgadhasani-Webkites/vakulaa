    <header id="topbar" class="ph10">
        ...
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="crumb-link">
                    <a href="">Create Country/Add Country</a>
                </li>
            </ol>
        </div>
        ...
        <div class="row">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                   <form  id="country_frm" action="<?php echo base_url('admin/country/process_edit'); ?>" method="post" class="form-horizontal" role="form">
                        <div class="clearfix">&nbsp;</div>
                        <div class="row ph15 mb10">
                            <div class="col-lg-4 col-md-4 col-sm-6">

                                <h5><small>Create Country*</small></h5>
                               <input type="text" value="<?php echo $country['country'];?>" name="country" class="form-control" placeholder="Enter Country">
                               <input type="hidden" name="id" value="<?php echo $country['id'];?>">

                            </div>
                            <div class="col-lg-1 col-md-3 col-sm-6 col-xs-12">
                                <h5><small>&nbsp;</small></h5>
                                <input type="submit" class="btn btn-success btn-block" id="search_stud" value="Update" >
                            </div>
