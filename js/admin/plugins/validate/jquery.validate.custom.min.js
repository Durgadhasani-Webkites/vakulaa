...
}, $.validator.format("This charatcer is not allowed")),

$.validator.addMethod("noSpecialsspace", function (a, t) {
    var i = /^[a-zA-Z0-9-]+$/i;
    return this.optional(t) || a.match(i)
}, $.validator.format("Special charatcers and space are not allowed")),

$.validator.addMethod("validName", function (a, t) {
    var i = /^[a-zA-Z ]+$/i;
    return this.optional(t) || a.match(i)
